...
* [constructor](maybe.md#constructor)

### Properties

* [length](maybe.md#length)
* [describer](maybe.md#static-describer)
* [kind](maybe.md#static-kind)

### Accessors

* [isOptional](maybe.md#isoptional)
* [isRequired](maybe.md#isrequired)

### Methods

* [concat](maybe.md#concat)
* [describe](maybe.md#describe)
* [every](maybe.md#every)
* [filter](maybe.md#filter)
* [forEach](maybe.md#foreach)
* [getInitializer](maybe.md#getinitializer)
* [getKind](maybe.md#getkind)
* [hasInitializer](maybe.md#hasinitializer)
* [indexOf](maybe.md#indexof)
* [join](maybe.md#join)
* [lastIndexOf](maybe.md#lastindexof)
* [map](maybe.md#map)
* [onValidation](maybe.md#onvalidation)
* [pop](maybe.md#pop)
* [push](maybe.md#push)
* [reduce](maybe.md#reduce)
* [reduceRight](maybe.md#reduceright)
* [reverse](maybe.md#reverse)
* [setInitializer](maybe.md#setinitializer)
* [shift](maybe.md#shift)
* [slice](maybe.md#slice)
* [some](maybe.md#some)
* [sort](maybe.md#sort)
* [splice](maybe.md#splice)
* [toLocaleString](maybe.md#tolocalestring)
* [toString](maybe.md#tostring)
* [unshift](maybe.md#unshift)
* [getDescriber](maybe.md#static-getdescriber)
* [setDescriber](maybe.md#static-setdescriber)

## Constructors

###  constructor

\+ **new Maybe**(...`expectations`: any[]): *[Maybe](maybe.md)*
...
▪ **kind**: *[KINDS](../enums/kinds.md)* = KINDS.MAYBE
