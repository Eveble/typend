...
* [constructor](propsof.md#constructor)

### Properties

* [length](propsof.md#length)
* [describer](propsof.md#static-describer)
* [kind](propsof.md#static-kind)

### Accessors

* [isOptional](propsof.md#isoptional)
* [isRequired](propsof.md#isrequired)

### Methods

* [concat](propsof.md#concat)
* [describe](propsof.md#describe)
* [every](propsof.md#every)
* [filter](propsof.md#filter)
* [forEach](propsof.md#foreach)
* [generate](propsof.md#generate)
* [getInitializer](propsof.md#getinitializer)
* [getKind](propsof.md#getkind)
* [hasInitializer](propsof.md#hasinitializer)
* [indexOf](propsof.md#indexof)
* [join](propsof.md#join)
* [lastIndexOf](propsof.md#lastindexof)
* [map](propsof.md#map)
* [onValidation](propsof.md#onvalidation)
* [pop](propsof.md#pop)
* [push](propsof.md#push)
* [reduce](propsof.md#reduce)
* [reduceRight](propsof.md#reduceright)
* [reverse](propsof.md#reverse)
* [setInitializer](propsof.md#setinitializer)
* [shift](propsof.md#shift)
* [slice](propsof.md#slice)
* [some](propsof.md#some)
* [sort](propsof.md#sort)
* [splice](propsof.md#splice)
* [toLocaleString](propsof.md#tolocalestring)
* [toString](propsof.md#tostring)
* [unshift](propsof.md#unshift)
* [getDescriber](propsof.md#static-getdescriber)
* [setDescriber](propsof.md#static-setdescriber)

## Constructors

###  constructor

\+ **new PropsOf**(...`expectations`: any[]): *[PropsOf](propsof.md)*
...
▸ **generate**(`library`: [Library](../interfaces/types.library.md)): *[Collection](collection.md)*
...
Instance of `Collection` pattern as representation of type's properties.
