...
* [constructor](unrecognized.md#constructor)

### Properties

* [length](unrecognized.md#length)
* [describer](unrecognized.md#static-describer)
* [kind](unrecognized.md#static-kind)

### Accessors

* [isOptional](unrecognized.md#isoptional)
* [isRequired](unrecognized.md#isrequired)

### Methods

* [concat](unrecognized.md#concat)
* [describe](unrecognized.md#describe)
* [every](unrecognized.md#every)
* [filter](unrecognized.md#filter)
* [forEach](unrecognized.md#foreach)
* [getInitializer](unrecognized.md#getinitializer)
* [getKind](unrecognized.md#getkind)
* [hasInitializer](unrecognized.md#hasinitializer)
* [indexOf](unrecognized.md#indexof)
* [join](unrecognized.md#join)
* [lastIndexOf](unrecognized.md#lastindexof)
* [map](unrecognized.md#map)
* [onValidation](unrecognized.md#onvalidation)
* [pop](unrecognized.md#pop)
* [push](unrecognized.md#push)
* [reduce](unrecognized.md#reduce)
* [reduceRight](unrecognized.md#reduceright)
* [reverse](unrecognized.md#reverse)
* [setInitializer](unrecognized.md#setinitializer)
* [shift](unrecognized.md#shift)
* [slice](unrecognized.md#slice)
* [some](unrecognized.md#some)
* [sort](unrecognized.md#sort)
* [splice](unrecognized.md#splice)
* [toLocaleString](unrecognized.md#tolocalestring)
* [toString](unrecognized.md#tostring)
* [unshift](unrecognized.md#unshift)
* [getDescriber](unrecognized.md#static-getdescriber)
* [setDescriber](unrecognized.md#static-setdescriber)

## Constructors

###  constructor

\+ **new Unrecognized**(...`expectations`: any[]): *[Unrecognized](unrecognized.md)*
...
▪ **kind**: *[KINDS](../enums/kinds.md)* = KINDS.UNRECOGNIZED
