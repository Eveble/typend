...
* [constructor](instanceof.md#constructor)

### Properties

* [length](instanceof.md#length)
* [describer](instanceof.md#static-describer)
* [kind](instanceof.md#static-kind)

### Accessors

* [isOptional](instanceof.md#isoptional)
* [isRequired](instanceof.md#isrequired)

### Methods

* [concat](instanceof.md#concat)
* [describe](instanceof.md#describe)
* [every](instanceof.md#every)
* [filter](instanceof.md#filter)
* [forEach](instanceof.md#foreach)
* [getInitializer](instanceof.md#getinitializer)
* [getKind](instanceof.md#getkind)
* [hasInitializer](instanceof.md#hasinitializer)
* [indexOf](instanceof.md#indexof)
* [join](instanceof.md#join)
* [lastIndexOf](instanceof.md#lastindexof)
* [map](instanceof.md#map)
* [onValidation](instanceof.md#onvalidation)
* [pop](instanceof.md#pop)
* [push](instanceof.md#push)
* [reduce](instanceof.md#reduce)
* [reduceRight](instanceof.md#reduceright)
* [reverse](instanceof.md#reverse)
* [setInitializer](instanceof.md#setinitializer)
* [shift](instanceof.md#shift)
* [slice](instanceof.md#slice)
* [some](instanceof.md#some)
* [sort](instanceof.md#sort)
* [splice](instanceof.md#splice)
* [toLocaleString](instanceof.md#tolocalestring)
* [toString](instanceof.md#tostring)
* [unshift](instanceof.md#unshift)
* [getDescriber](instanceof.md#static-getdescriber)
* [setDescriber](instanceof.md#static-setdescriber)

## Constructors

###  constructor

\+ **new InstanceOf**(...`expectations`: any[]): *[InstanceOf](instanceof.md)*
...
▪ **kind**: *[KINDS](../enums/kinds.md)* = KINDS.INSTANCE_OF
...
Name | Type | Description |
------ | ------ | ------ |
`type` | any | Type that will be used to validate value. |
